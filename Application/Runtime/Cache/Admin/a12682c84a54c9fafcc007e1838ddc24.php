        ...
        <form class="layui-form">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <textarea rows="3" cols="20" id="introduce" name="introduce" class="layui-textarea"></textarea>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                <input type="radio" name="grade" lay-skin="primary" title="超级管理员" checked="" value="1">
                <input type="radio" name="grade" lay-skin="primary" title="编辑人员" value="2">
              </div>
          </div>
          <div class="layui-form-item">
        ...
        layui.use(['form','layer'], function(){
          ...
          form.on('submit(add)', function(data){
            //发异步，把数据提交给php
              ...
              $.ajax({
                  type: 'post',
                  url: "<?php echo U('Admin/admin_do_add');?>",
                  data:{"username":username,"phone":phone,"grade":grade,"introduce":introduce,"email":email,"password":password,"repass":repass,"head_pic":head_pic},
                  dataType : "json",
