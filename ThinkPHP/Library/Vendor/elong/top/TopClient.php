...
{
    // 测试路径
/*	public $appKey="c8d0c1da7645c08d95bd57c56985d7ea";

	public $secretKey="27e012fd76056860461ffce18cc159b8";

    public $gatewayUrl = "http://api.test.lohoo.com/rest";

	public $format = "json";
        
    public $user="Agent1481609568";*/
    // 正式路径
    public $appKey="94caf137145b8e2c3129b427355f90fd";

    public $secretKey="e5017a5c1964426ae57d4174c398dd8c";

    public $gatewayUrl = "http://api.elong.com/rest";

    public $format = "json";

    public $user="6e0ba852e304fd7aa7cfc9436aa2ac3b";
