...
class Common_util_pub
{
	...
	public function getSign($Obj)
	{
		...
		//签名步骤二：在string后加入KEY
		$String = $String."&key=".'beijingchailvtianxia1239226202xx';
	...
	function postXmlSSLCurl($xml,$url,$second=30)
	{
            ...
            curl_setopt($ch,CURLOPT_SSLCERT, "／ThinkPHP/Library/Vendor/WxPay/WxPayPubHelper/cacert/apiclient_cert.pem");
            //默认格式为PEM，可以注释
            curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
            curl_setopt($ch,CURLOPT_SSLKEY, "/ThinkPHP/Library/Vendor/WxPay/WxPayPubHelper/cacert/apiclient_key.pem");
            //post提交方式
            curl_setopt($ch,CURLOPT_POST, true);
            curl_setopt($ch,CURLOPT_POSTFIELDS,$xml);
            $data = curl_exec($ch);
...
class Wxpay_client_pub extends Common_util_pub 
{
	...
	function createXml()
	{
	   	$this->parameters["appid"] = 'wx60ec248807b22ce0';//公众账号ID
	   	$this->parameters["mch_id"] = '1239226202';//商户号
	...
	function postXml()
	{
	    ...
	    $this->parameters["appid"] = 'wx60ec248807b22ce0';//公众账号ID
	   	$this->parameters["mch_id"] = '1239226202';//商户号
	   	$this->parameters["spbill_create_ip"] = '127.0.0.1';//商户号
	    $this->parameters["nonce_str"] = $this->createNoncestr();//随机字符串
	    $this->parameters["sign"] = $this->getSign($this->parameters);//签名
	...
	function createXml()
	{
		try
		{
			...
			if($this->parameters["out_trade_no"] == null) 
			{
		   	...
		   	$this->parameters["spbill_create_ip"] = $_SERVER["HTTP_X_FORWARDED_FOR"] ;//终端ip	 
		    $this->parameters["nonce_str"] = $this->createNoncestr();//随机字符串
		    $this->parameters["sign"] = $this->getSign($this->parameters);//签名
		    return  $this->arrayToXml($this->parameters);
...
class Wxpay_server_pub extends Common_util_pub 
{
	...
	{
	    return $this->data = xmlToArray($xml);
	}
...
class JsApi_pub extends Common_util_pub
{
	...
	{
		$urlObj["appid"] = 'wx60ec248807b22ce0';
